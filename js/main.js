  ...
  $(document).ready(function () {
    $.ajax({
      ...
      success: function (data) {
        ...
        var totalNumOfUsers, totalNumOfAccounts, totalNumOfThreads, totalNumOfFollowUpThreads, totalNumOfUserModels, totalValidRefreshTokens, avgMessagesPerThread;
        ...
        $().text(totalNumOfUserModels);
        $().text(totalValidRefreshTokens);
